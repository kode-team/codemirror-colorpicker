(function(mod) {
  ...
  "use strict";
	...
	var colorpicker_class = 'codemirror-colorpicker';
	...
	codemirror_colorpicker.prototype.open_color_picker = function (el) {
		...
		//TODO : colorpicker 연동이 필요하다. 
		
		var r = (Math.floor(Math.random() * 255) % 255).toString(16);
		...
		this.cm.replaceRange("#"+r+"ff00", { line : lineNo, ch : ch } , { line : lineNo, ch : ch + color.length }, color);
	}
